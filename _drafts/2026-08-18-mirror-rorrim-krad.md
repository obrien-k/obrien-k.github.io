...
I will dole out some specific advice when it comes to tripping on acid, but know that this advice hasn't really ever done much for me outside of that which can be read in the previously mentioned Albert Hoffman book. However, assuming you're not going to read anything else, [you must be a proper mind set and physical setting before dosing LSD](https://www.academia.edu/33412177/Constructing_drug_effects_A_history_of_set_and_setting).

- "Trip blanket", one that has a amicable texture to touch, and warm enough for when you inevitably get the chills on LSD.
- "Distraction device", popular items include: A rubik's cube, fidget spinner, gameboy, what have you. We all carry one in our phones, but I try to limit my application use to something like [Frax](https://fr.ax/).
- "Go with the flow" -- The primary reason that none of this advice has been entirely useful is because of this, plans are out of the window regardless of how well you plan the itenerary. I've had this playlist in iTunes (Apple Music, now) called "The Trip" for decades and have never once listened to it while tripping.
...
Today, like with many of these thoughtlines and intersections of philosophy, design, and form, there were predicated conversations that in retrospect were synchronicity with what was going to occur. I mention the TV Show "Heroes", and of course one of the first people we bring up is Claire Bennett. "Save the cheerleader, save the world". It's too late to save our cheerleader now.
